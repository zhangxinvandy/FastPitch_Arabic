...
def get_symbols(symbol_set='english_basic'):
    ...
    elif symbol_set == "arabic_basic":
        from .arb.arabic_phonemes import valid_symbols
...
def get_pad_idx(symbol_set='arabic_basic'):
    if symbol_set in {'english_basic', 'english_basic_lowercase', 'english_mandarin_basic', 'arabic_basic'}:
        return 0
    else:
